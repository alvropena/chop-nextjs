...
export default function ContactPage() {
    return (
        <Card className="mx-auto max-w-md p-6 bg-gradient-to-r shadow-lg font-sans">
            <CardHeader>
            ...
            <CardContent>
                <form action="mailto:me@alvropena.com" method="post" className="space-y-4">
                    ...
                    <div className="space-y-2">
                        ...
                        <Input name="email" id="email" type="email" placeholder="Enter your subject" className="shadow-sm" />
                    </div>
                    <div className="space-y-2">
