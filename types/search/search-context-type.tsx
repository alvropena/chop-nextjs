...
export type SearchContextType = {
    ...
    recentSearches: SearchResultType[];  // Array to store recent searches (users or communities)
    trendingCommunities: SearchCommunityType[];  // Array to store trending communities
    searchResults: SearchResultType[];  // Array to store search results (users or communities)
    ...
    addRecentSearch: (search: SearchResultType) => void;  // Function to add a recent search (either user or community)
    setSearchResults: (results: SearchResultType[]) => void;  // Function to set the search results
    fetchTrendingCommunities: () => Promise<void>;  // Function to fetch trending communities
